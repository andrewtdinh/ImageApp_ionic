...
var fb = new Firebase("https://animal.firebaseio.com/");
var imageApp = angular.module('starter', ['ionic', 'ngCordova', 'firebase']);

imageApp.config(function($stateProvider, $urlRouterProvider) {
  $stateProvider
  .state("firebase", {url: "/firebase", templateUrl: "templates/firebase.html", controller: "FirebaseController", cache: false})
  .state("secure", {url: "/secure", templateUrl: "templates/secure.html", controller: "SecureController"});
